        ...
        Events.subscribe(PlayerJoinEvent.class).handler(e -> {
            ...
            player.sendMessage(
                    Util.getComponent("<color:#f0f01c><bold>OrleansMC</bold> sunucusuna hoş geldin!</color>")
                            .append(Util.getComponent("<newline><color:#ff5999><bold>Discord</bold> sunucumuz: </color><click:open_url:'https://discord.gg/orleans'><underlined><color:#7d8aff>https://discord.gg/orleans</color></underlined></click>"))
